    ...
    return (
        <>
            <svg height="70" width="100" viewBox="0 0 600 600">
                ...
                <path fill="none" stroke={stroke} strokeWidth="20" strokeLinecap="round" transform="matrix(1 0 0 -1 317.173 323.818)" d="M247.706 249.514L-247.706 -249.514" fill-rule="evenodd" />
            </svg>
        </>
    )
}
