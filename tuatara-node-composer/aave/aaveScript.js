...
function parseAvveQuery(r, d) {
    ...
    function writeF() {
        fs.writeFile('D:/Projects/TuraTara/Repo/TuaTara-stream-bot/tuatara-node-composer/aave/aData.json', JSON.stringify({ borrowDat, depositDat, rateDat }), function (err) {
            if (err) throw err;
            console.log('Saved!');
        });
    }
